prompts = {
    ...
    In addition to outputing the results into the results directory write a small report in the results directory 
    that summarizes the pipeline process and outputs any additional notes on hte analysis in a summary.txt file. 
    """,
}
